...
#include "light_sensor.h"   // 炫彩灯板光敏电阻接口
...
static void mqttDemoTask(void *arg)
{
    ...
    // 向主题"OpenHarmony/devices/Pegasus0001/LightSensor/Message"发布上线消息
    char *ptopic = "OpenHarmony/devices/Pegasus0001/LightSensor/Message";       // 主题
    ...
    // 向主题"OpenHarmony/devices/Pegasus0001/LightSensor/Message"上报光敏电阻数据
    // 工作循环
    while (1)
    {
        char payload[64] = {0};                                         // 消息内容
        snprintf(payload, sizeof(payload),
                 "{\"device_id\":\"Pegasus0001\", \"light\":\"%d\"}",
