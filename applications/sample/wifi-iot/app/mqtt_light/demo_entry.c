...
#include "traffic_light.h"  // 交通灯板三色灯接口
...
static void mqttDemoTask(void *arg)
{
    ...
    // 订阅主题"OpenHarmony/devices/Pegasus0001/TrafficLight/Command"
    char *stopic = "OpenHarmony/devices/Pegasus0001/TrafficLight/Command";  // 主题
    ...
    // 向主题"OpenHarmony/devices/Pegasus0001/TrafficLight/Message"发布一条消息
    char *ptopic = "OpenHarmony/devices/Pegasus0001/TrafficLight/Message";  // 主题
    char *payload = "online";                                               // 消息内容
