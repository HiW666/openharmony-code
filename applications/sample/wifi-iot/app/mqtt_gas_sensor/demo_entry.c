...
static void mqttDemoTask(void *arg)
{
    ...
    // 向主题"OpenHarmony/devices/Pegasus0001/GasSensor/Message"发布上线消息
    char *ptopic = "OpenHarmony/devices/Pegasus0001/GasSensor/Message";         // 主题
    ...
    // 向主题"OpenHarmony/devices/Pegasus0001/GasSensor/Message"上报可燃气体传感器数据
    // 工作循环
    while (1)
    {
        char payload[64] = {0};                                         // 消息内容
        snprintf(payload, sizeof(payload),
                 "{\"device_id\":\"Pegasus0001\", \"gas\":\"%.3f\"}",
